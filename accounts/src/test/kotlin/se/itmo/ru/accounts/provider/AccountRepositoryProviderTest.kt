package se.itmo.ru.accounts.provider
...
class AccountRepositoryProviderTest {
    ...
    fun `test saveAccount with new account`() {
        val account = Account(accountId = UUID.randomUUID(), username = "testUser", email = "test@example.com")
    ...
    fun `test saveAccount with existing username`() {
        val account = Account(accountId = UUID.randomUUID(), username = "existingUser", email = "test@example.com")
    ...
    fun `test saveAccount with existing email`() {
        val account = Account(accountId = UUID.randomUUID(), username = "testUser", email = "existing@example.com")
    ...
    fun `test updateAccount with valid account`() {
        ...
        val updatedAccount = Account(accountId = UUID.randomUUID(), username = "newUser", email = "new@example.com")
    ...
    fun `test updateAccount with existing username`() {
        val accountId = UUID.randomUUID()
        val existingAccount = Account(accountId = accountId, username = "oldUser", email = "old@example.com")
        val updatedAccount = Account(accountId = UUID.randomUUID(), username = "existingUser", email = "new@example.com")
    ...
    fun `test updateAccount with existing email`() {
        val accountId = UUID.randomUUID()
        val existingAccount = Account(accountId = accountId, username = "oldUser", email = "old@example.com")
        val updatedAccount = Account(accountId = UUID.randomUUID(), username = "newUser", email = "existing@example.com")
